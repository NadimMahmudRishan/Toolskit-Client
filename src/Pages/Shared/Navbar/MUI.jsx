...
import { Avatar, Badge, CircularProgress, Divider, Drawer, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Menu, TextField, } from '@mui/material';
import useAuth from '../../../hooks/useAuth';
import { MdClose, MdContacts, MdDashboard, MdDescription, MdDomain, MdExitToApp } from 'react-icons/md';
...
function ResponsiveAppBar(props) {
        ...
        <div>
            <List onClick={handleDrawerClose}>
                ...
                <ListItem disablePadding>
                    <ListItemButton
                        sx={{
                            color: location.pathname === '/blog' ? '#CC3333' : 'inherit',
                            justifyContent: open ? 'initial' : 'center',
                        }}
                        component={Link}
                        to="/blog"
    ...
    const TopDrawerContent = (
        <Box className='lg:min-h-[450px] min-h-[180px]' sx={{ width: '100%', paddingTop: 6, paddingLeft: 2, paddingRight: 2 }} role="presentation">
                        ...
                        >
                            <div>
                                <div className="flex justify-center p-6">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="120px" fill="" height="20px"><path d="M118.5,20h-1.1c-0.6,0-1.2-0.4-1.4-1l-1.5-4h-6.1l-1.5,4c-0.2,0.6-0.8,1-1.4,1h-1.1c-1,0-1.8-1-1.4-2l1.1-3
