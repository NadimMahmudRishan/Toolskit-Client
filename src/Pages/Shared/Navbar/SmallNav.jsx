import { Box, CircularProgress, Container, IconButton, TextField } from '@mui/material';
...
const SmallNav = () => {
    ...
    return (
        <div className='bg-base-200'>
            <Container>
                <div className='lg:flex hidden justify-between items-center py-8 bg-base-200'>
                    ...
                    <Box
                        ...
                        sx={{ display: 'flex', alignItems: 'center', flexGrow: 1, maxWidth: 600 }}
                    >
                        <TextField
                            name="search"
                            variant="outlined"
                        ...
                        <IconButton type="submit" sx={{ color: 'black' }}>
                            {isLoading ? <CircularProgress size={24} /> : <IoSearch size={24} />}
                        </IconButton>
                    </Box>
                    <div>
