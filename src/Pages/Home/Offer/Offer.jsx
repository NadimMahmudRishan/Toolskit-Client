...
const Offer = () => {
    return (
        <div className='my-10 lg:flex w-full items-center justify-center gap-5'>
            <div className='flex items-center gap-4 border-[1px] border-gray-300 py-6 w-full px-5 shadow-md'>
